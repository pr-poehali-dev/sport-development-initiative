...
const Index = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      details: 'Каяк экстрим — зрелищная дисциплина с прыжками с рампы, сбором буёв и динамичными маневрами на воде.',
      facts: [
        'Спортсмены прыгают с рампы на каяках',
        'Задача: собрать буи, которые можно трогать и двигать руками',
        'Требуется отличная координация и скорость реакции',
        'Зрелищные прыжки и акробатические элементы',
        'Соревнования на время с преодолением препятствий'
      ]
    },
    {
      icon: 'Users',
