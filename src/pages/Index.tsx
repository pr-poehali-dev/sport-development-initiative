...
const Index = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      details: 'Каяк экстрим — это фристайл на бурной воде. Трюки, акробатика и невероятные эмоции в борьбе с потоком.',
      facts: [
        'Обучение элементам фристайла: сальто, винты, сёрфинг на волне',
        'Тренировки на естественных и искусственных порогах',
        'Требуется базовая подготовка в гребном слаломе',
        'Участие в фристайл-соревнованиях и родео',
        'Специальные укороченные каяки для трюков'
      ]
    },
    {
      icon: 'Users',
